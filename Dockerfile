...
ENV TFTPBOOT /tmp
CMD ["--listen-address ${LISTENADD} --dhcp-range ${DHCPRANGE}，${LEASETIME}h --dhcp-option 3,${DHCPGW} --dhcp-lease-max=254 --tftp-root=%{TFTPBOOT} --dhcp-boot ${TFTPBOOT}/pxelinux.0“]
